...
test('Renders with caption', () => {
	assert.strictEqual(
		figureShortcode('A caption.', '/assets/image.png', 'A description of the image.'),
		'<figure><img src="/assets/image.png" alt="A description of the image."><figcaption><p>A caption.</p></figcaption></figure>\n',
	);
});
...
test('Renders caption containing line breaks without <br> tag', () => {
	assert.strictEqual(
		figureShortcode('A caption\nwith line break.', '/assets/image.png', 'A description of the image.'),
		'<figure><img src="/assets/image.png" alt="A description of the image."><figcaption><p>A caption\nwith line break.</p></figcaption></figure>\n',
	);
});
